          ...
          {filteredCandidates.length > 0 ? (
            filteredCandidates.map((c) => (
              <CTableRow key={c.email}>
                ...
                <CTableDataCell>
                  {c.resume_url ? (
                    <a href={c.resume_url} target="_blank" rel="noopener noreferrer" style={{ color: '#326396', textDecoration: 'underline' }}>
                      View Resume
                    </a>
                  ) : 'No Resume'}
                </CTableDataCell>
...
<CButton
  onClick={handleSave}
  style={{
    width: '200px',              // make it a bit longer
    backgroundColor: '#4CAF50',  // new green color
    borderRadius: '2px',         // rounded corners
    color: '#fff',               // text color
    fontWeight: '500',           // optional: medium font weight
