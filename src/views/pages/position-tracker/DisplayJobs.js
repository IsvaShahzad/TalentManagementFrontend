...
//     const [totalJobsAssigned, setTotalJobsAssigned] = useState(0);
...
// useEffect(() => {
//     setTotalJobsPosted(jobs.length);
//     setTotalJobsAssigned(jobs.filter(j => j.assigned_to).length);
// }, [jobs]);
...
//     try {
//         console.log("deleting job", deletingJob)
...
//       {jobs.filter(j => j.assigned_to).length}
//     </div>
...
//   <label style={{ fontSize: '0.85rem', fontWeight: 500 }}>Skills</label>
//   <CFormInput
...
//             setEditableJob({
//               ...editableJob,
//               skills: editableJob.skills.filter((_, i) => i !== index)
//             });
//           }}
//         >
//           ×
